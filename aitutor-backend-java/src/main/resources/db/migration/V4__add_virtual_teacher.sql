...
VALUES
    ('teacher-001', '小跃', '亲切活泼，适合语言与通识课程', '/vrm/teacher001_girl.vrm', 'zhixiaoxia', '普通话', 1, 10),
    ('teacher-002', '知夏', '沉稳清晰，适合理工科讲解', '/vrm/teacher002_with_glasses_girl.vrm', 'zhixiaobai', '普通话', 1, 20),
